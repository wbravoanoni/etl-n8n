...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/z_usabilidad_monitoreo_enfermeria_downtown_UPC_UHI.log"),
...
def crear_tabla_z_cuestionario_downtown(cursor_mysql):
    ...
    CREATE TABLE IF NOT EXISTS z_usabilidad_monitoreo_enfermeria_downtown_UPC_UHI (
        ID VARCHAR(6),
...
try:
    ...
    cursor_mysql.execute("TRUNCATE TABLE z_usabilidad_monitoreo_enfermeria_downtown_UPC_UHI")
    conn_mysql.commit()
    ...
    insert_query = f"""
        INSERT INTO z_usabilidad_monitoreo_enfermeria_downtown_UPC_UHI ({columns_sql})
        VALUES ({placeholders})
    """
