...
scripts = [
    "z_usabilidad_coloproctologia_agendas_diagnosticos.py",
    "z_usabilidad_coloproctologia_agendas_evoluciones.py",
    "z_usabilidad_coloproctologia_agendas_sol_quirurgica.py",
    "z_usabilidad_coloproctologia_procedimientos.py"
]
