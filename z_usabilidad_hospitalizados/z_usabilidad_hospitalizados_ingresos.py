...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("logs/z_usabilidad_hospitalizados_ingresos.log"),
...
try:
    ...
    try:
        ...
        conn_mysql.commit()
        logging.info("Tabla 'z_usabilidad_hospitalizados_ingresos' truncada exitosamente.")
