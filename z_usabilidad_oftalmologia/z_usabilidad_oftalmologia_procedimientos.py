...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("logs/z_usabilidad_oftalmologia_procedimientos.log"),
...
try:
    ...
    query = ''' 
            ...
            OEORI_APPT_DR->APPT_AS_ParRef->AS_RES_ParRef->RES_CTLOC_DR in (2869,2871,2872,2873,2874,2875,2680,3437,3850,4260,4254,4264,4257,4261,4253,4259,4258,4256,4617,4531,4532)
            '''
    
            # OEORI_APPT_DR->APPT_AS_ParRef->AS_RES_ParRef->RES_CTPCP_DR->CTPCP_Spec_DR->CTSPC_Desc = 'Oftalmología';
    
            #   OEORI_OrdDept_DR in (2869,2871,2872,2873,2874,2875,2680,3437,3850,4260,4254,4264,4257,4261,4253,4259,4258,3853,4617) and
    ...
    try:
        ...
        conn_mysql.commit()
        logging.info("Tabla 'z_usabilidad_oftalmologia_procedimientos' truncada exitosamente.")
