...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/z_usabilidad_oftalmologia_contrarreferencias.log"),
...
try:
    ...
    query = ''' 
        ...
        (CASE WHEN PAADM_RefClinTo_DR->CTRFC_Desc IS NULL THEN PAADM_WaitList_DR->WL_RefHosp_DR->CTRFC_Desc ELSE PAADM_RefClinTo_DR->CTRFC_Desc END)
