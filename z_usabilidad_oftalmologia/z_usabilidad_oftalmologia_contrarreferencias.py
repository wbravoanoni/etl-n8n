...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("logs/z_usabilidad_oftalmologia_contrarreferencias.log"),
...
#
#        IMPORTANTE -> Falta agregar este filtro cuando aparescan contrareferencias de estos locales
...
#
    ...
    try:
        cursor_mysql.execute("TRUNCATE TABLE z_usabilidad_oftalmologia_contrarreferencias")
        conn_mysql.commit()
        logging.info("Tabla 'z_usabilidad_oftalmologia_contrarreferencias' truncada exitosamente.")
    ...
    insert_query = """
        INSERT INTO z_usabilidad_oftalmologia_contrarreferencias (
            nro_episodio,
            nro_registro,
            local,
            cod_recurso_cita,
