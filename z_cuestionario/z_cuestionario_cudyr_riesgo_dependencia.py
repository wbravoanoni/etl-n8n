...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/z_cuestionario_cudyr_riesgo_dependencia.log"),
...
def crear_tabla_z_cudyr_riesgo_dependencia(cursor_mysql):
    create_table_sql = """
    CREATE TABLE IF NOT EXISTS z_cuestionario_cudyr_riesgo_dependencia (
...
try:
    ...
    conn_mysql.commit()
    logging.info("Tabla z_cuestionario_cudyr_riesgo_dependencia verificada/creada.")

    # Truncar tabla
    cursor_mysql.execute("TRUNCATE TABLE z_cuestionario_cudyr_riesgo_dependencia")
    conn_mysql.commit()
    ...
    # =========================
    insert_query = """
        INSERT INTO z_cuestionario_cudyr_riesgo_dependencia (
