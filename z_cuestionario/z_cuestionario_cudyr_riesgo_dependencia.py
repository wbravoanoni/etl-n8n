...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("logs/z_cuestionario_cudyr_riesgo_dependencia.log"),
...
try:
    ...
    query = ''' 
            ...
            from questionnaire.QTCERIESGO as a
    ...
    try:
        ...
        conn_mysql.commit()
        logging.info("Tabla 'z_cuestionario_cudyr_riesgo_dependencia' truncada exitosamente.")
