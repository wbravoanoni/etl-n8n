...
try:
    ...
    query = ''' 
            ...
            a.Q11,a.Q12,a.Q13,a.Q14,a.Q15,a.Q16,a.Q17,a.Q20,a.Q21,a.Q22,a.Q23,a.Q24,a.Q25,
    ...
    for row in rows:
        ...
        Q23= '' if row[27] is None else str(row[27])
        Q24= '' if row[28] is None else str(row[28])
        Q25= '' if row[29] is None else str(row[29])
        Q30= '' if row[30] is None else str(row[30])
        Q31= '' if row[31] is None else str(row[31])
        Q32= '' if row[32] is None else str(row[32])
        Q33= '' if row[33] is None else str(row[33])
        Q34= '' if row[34] is None else str(row[34])
        Q35= '' if row[35] is None else str(row[35])
        Q40= '' if row[36] is None else str(row[36])
        Q41= '' if row[37] is None else str(row[37])
        Q42= '' if row[38] is None else str(row[38])
        Q43= '' if row[39] is None else str(row[39])
        Q44= '' if row[40] is None else str(row[40])
        Q45= '' if row[41] is None else str(row[41])
        Q46= '' if row[42] is None else str(row[42])
    ...
    try:
        ...
        conn_mysql.commit()
        logging.info("Tabla 'z_cuestionario_downtown' truncada exitosamente.")
    ...
    insert_query = """
        INSERT INTO z_cuestionario_downtown (
            ID,
            fecha_creacion,
            hora_creacion,
            puntaje,
