...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("logs/z_cuestionario_cudyr_salud_mental.log"),
...
# =========================
def crear_tabla_z_cuestionario_cudyr_salud_mental(cursor_mysql):
    create_table_sql = """
    CREATE TABLE IF NOT EXISTS z_cuestionario_cudyr_salud_mental (
        fecha_creacion VARCHAR(10),
        hora_creacion VARCHAR(8),
        puntaje VARCHAR(2),
        usuario_creador VARCHAR(35),
        episodio VARCHAR(11),
...
try:
    ...
    crear_tabla_z_cuestionario_cudyr_salud_mental(cursor_mysql)
    conn_mysql.commit()
    logging.info("Tabla z_cuestionario_cudyr_salud_mental verificada/creada.")
