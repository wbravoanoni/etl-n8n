...
logging.basicConfig(level=logging.INFO, 
                    ...
                    handlers=[logging.FileHandler("logs/z_usabilidad_uto_imagenes.log"),
...
try:
    ...
    query = ''' 
            ...
            AND PIC_UserCreated->SSUSR_DefaultDept_DR IN (4070,4994)
        '''
...
# 4994  HDS-07-854  Procedimientos UTO HDS
    ...
    try:
        cursor_mysql.execute("TRUNCATE TABLE z_usabilidad_uto_imagenes")
        conn_mysql.commit()
        logging.info("Tabla 'z_usabilidad_uto_imagenes' truncada exitosamente.")
    ...
    insert_query = """
        INSERT INTO z_usabilidad_uto_imagenes (
            episodio,
            tipo_registro,
            local,
            fecha_creacion,
